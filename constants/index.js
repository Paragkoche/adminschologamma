export * from "@/constants/formstruct"; //for impor the formdata
...
export const sectionLinks = [
  ...
  },
  {
    name: "Sliders",
    path: "/sliders",
    logo: "/icons/slider.png",
  },
  {
    name: "Committee",
    path: "/committee",
    logo: "/icons/committee.png",
  },
  {
    name: "events",
    path: "/events",
    logo: "/icons/events.png",
  },
];

export const sliderdata = [
  { name: "1", imageLink: "/", description: "this slide for the image" },
  { name: "2", imageLink: "/", description: "this slide for the image" },
  { name: "3", imageLink: "/", description: "this slide for the image" },
