...
export const POST = async (req) => {
  ...
  try {
    ...
    if (check) {
      return new Response(
        JSON.stringify({
          msg: "This username   already exsit !",
          ok: true,
          type: "warning",
        }),
        { status: 200 },
    ...
    if (check1) {
      return new Response(
        JSON.stringify({
          msg: "This name  or committee already exsit !",
          ok: true,
          type: "warning",
        }),
        { status: 200 },
    ...
    return new Response(
      JSON.stringify({
        msg: "New Committee has been created SuccessFully ",
        type: "success",
        ok: true,
      }),
      { status: 200 },
    ...
    return new Response(
      JSON.stringify({
        msg: "Failed to fetch the data for user",
        error: error,
        type: "error",
        ok: false,
      }),
