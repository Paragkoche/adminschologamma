...
const Nav = () => {
  ...
  return (
    <nav className="bg-red-500 text-white fixed w-[100vw] z-[29]  top-0 left-0 right-0">
      <div className="navbar ">
        <div className="flex-1">
          <Link
            href={"/"}
            className="px-2 py-[2px] normal-case text-md font-semibold "
          >
            S Admin Pannel
          </Link>
        </div>
          ...
          <ul className="menu menu-horizontal px-1">
            {!auth.user ? (
              ...
              <>
                <li>profile</li>
                <button
                  className="px-[6px] py-[2px]  text-white rounded-lg shadow-lg cursor-pointer hover:bg-red-600"
                  onClick={() => LogOut()}
                >
                  logout
                </button>
