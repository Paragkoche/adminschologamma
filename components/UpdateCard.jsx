  ...
  const handleSubmitUpdate = async (e) => {
    ...
    if (isImageChange) {
      ...
      const res = await fetch(`/api/teams/teamperson/${year}`, {
        ...
        body: JSON.stringify({
          ...profileData,
          photoUrl: imgUrl.result.secure_url,
        }),
      });
      ...
      const filt = allDataCard.filter(
        (item) => item.BT_ID !== profileData.BT_ID,
      );

      data.ok &&
        setAllDataCard((pre) => [
          ...filt,
          { ...profileData, photoUrl: imgUrl.result.secure_url },
        ]);
  ...
  return (
    <div classeName="">
      ...
      <div className="flex flex-col justify-center items-center ">
        ...
        <CommButton
          title={"ADD"}
          handdleSubmite={handleSubmitUpdate}
          key={"hgjg"}
