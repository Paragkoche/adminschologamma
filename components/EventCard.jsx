      ...
      <div className="relative flex w-[300px] flex-col rounded-xl bg-red-50 bg-clip-border text-gray-700 shadow-md">
        <div className="relative mx-4 -mt-6 h-56 overflow-hidden rounded-xl bg-blue-gray-500 bg-clip-border text-white shadow-lg shadow-blue-gray-500/40">
          <Image
            ...
            alt={name ? name : ""}
          />
          <span className="absolute w-fit p-1 text-[10px] rounded-full bottom-0 right-0   bg-red-600 text-red-50 font-bold ">
            {organizer?.name}
          </span>
        </div>
        ...
        <div className="p-6 pt-0 flex justify-between  items-center ">
          ...
          <div className="flex justify-center items-center space-x-2">
            <button
              className="bg-blue-300 rounded-lg hover:bg-blue-500 w-[40px] h-[40px] flex justify-center items-center text-[25px]"
              onClick={(e) => handleIsUpdate(e, _id)}
            >
              {/* <Link className="p-2" href={'/events/update/23231'}  > */}
              <FaRegEdit color="white" className="" />
              {/* </Link> */}
            </button>
            <button className="bg-red-300 rounded-lg hover:bg-red-500 w-[40px] h-[40px] flex justify-center items-center text-[25px]">
